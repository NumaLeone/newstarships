...
//    private void updateStarships(Set<Integer> keySet){
//        updateStarship(keySet, starship1, lasers, starshipController1);
//        updateStarship(keySet, starship2, lasers2, starshipController2);
//    }
//    private void updateStarship(Set<Integer> keySet, Starship starship,List<Laser> lasers, StarshipController starshipController) {
//
...
//            } else {
//                starship = starshipController.keyHandle(keySet, starship, lasers);
//            }
//            starship = starshipController.starshipWarpEdge(starship, width, height);
//        }
//    }
